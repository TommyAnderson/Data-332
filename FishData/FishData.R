...
setwd("C:/Users/tomma/Data332/FishData/")

fish <- read_csv(here("Data332/FishData", "fish.csv"))
kelp_abur <- read_excel(here("Data332/FishData", "kelp_fronds.xlsx"), sheet = "abur")
